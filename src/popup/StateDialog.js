...
export default function StateDialog(props) {
  const { open, onClose, currentUserId, selectedCountry } = props
  ...
  useEffect(() => {
    ...
    //     console.log("finalArray after :: ", countryArrayIn);
  ...
  const handleCloseType = () => {
    ...
    if (!typeArray.userCountry) {
      ...
      const userPlaceData = {
        ...
        stateName: typeArray.userState
      }
      console.log('MY OBJ :: ', userPlaceData)

      axios
        .post(`${Config.serverUrl}admin/createState`, userPlaceData, {
          headers: {
            Authorization: token
          }
        })
            ...
            {/* <Grid item md={6} xs={12}>
              <Autocomplete
                ...
                getOptionLabel={(option) =>
                  option.userCountry || typeArray.userCountry
                }
                // defaultValue={}
                filterSelectedOption
                disabled={props.viweOnly}
